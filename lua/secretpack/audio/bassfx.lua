local addon = require("secretpack.audio.bass.addon")
local class = require("pl.class")
local const = require("secretpack.audio.bassfx.constants")
local fx = require("secretpack.audio.bass.fx")

local _fx_parameters = {
  [const.fx.bfx_rotate] = require("secretpack.audio.bassfx.fxparameters.bfx_rotate"),
  [const.fx.bfx_volume] = require("secretpack.audio.bassfx.fxparameters.bfx_volume"),
  [const.fx.bfx_peakeq] = require("secretpack.audio.bassfx.fxparameters.bfx_peakeq"),
...
function BASSFX:_init()
  ...
  self.bassfx = require("secretpack.audio.bindings.bassfx")
