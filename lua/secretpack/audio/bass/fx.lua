...
local const = require("secretpack.audio.bass.constants")
...
function FX:_init(handle, channel, fx)
  ...
  self.bass = require("secretpack.audio.bindings.bass")
  self.id = handle
...
FX._parameters = {
  [const.fx.dx8_chorus] = require("secretpack.audio.bass.fxparameters.dx8_chorus"),
  [const.fx.dx8_compressor] = require("secretpack.audio.bass.fxparameters.dx8_compressor"),
  [const.fx.dx8_distortion] = require("secretpack.audio.bass.fxparameters.dx8_distortion"),
  [const.fx.dx8_echo] = require("secretpack.audio.bass.fxparameters.dx8_echo"),
  [const.fx.dx8_flanger] = require("secretpack.audio.bass.fxparameters.dx8_flanger"),
  [const.fx.dx8_gargle] = require("secretpack.audio.bass.fxparameters.dx8_gargle"),
  [const.fx.dx8_i3dl2reverb] = require("secretpack.audio.bass.fxparameters.dx8_i3dl2reverb"),
  [const.fx.dx8_parameq] = require("secretpack.audio.bass.fxparameters.dx8_parameq"),
  [const.fx.dx8_reverb] = require("secretpack.audio.bass.fxparameters.dx8_reverb")
}
